            ...
            <div class="row">
                <div class="col-md-6">
                    <form class="form" enctype="multipart/form-data" method="POST"
                        action="<?php echo site_url('Sewa/sv_sewa'); ?>">
                        <div class="form-group">
                            <label for="exampleFormControlInput1">ID Sewa</label>
                            <input type="text" name="id_sewa" class="form-control" value="<?php echo $ids; ?>" readonly>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" class="form-control" name="bayar" value="<?php echo $total; ?>">
                        </div>
                        <div class="form-group">
