...
<section class="about-section section-padding" id="section_2">
    ...
    <div class="container">
                        ...
                        <tr>
                            ...
                            <?php foreach ($bukti as $buk) {
                                if ($buk->id_sewa == $val->id_sewa) {
                                    ...
                                    <td>
                                        <a style="font-size: 10px;" href="" data-toggle="modal" data-target="#ModalEdit<?php echo '_' . $idb; ?>" class="btn btn-sm btn-outline-success">Lihat Bukti</a>
                                    </td>
                                    <!-- Modal bukti -->
                                    <div class="modal fade" id="ModalEdit<?php echo '_' . $idb; ?>" tabindex="-1" aria-labelledby="ModalJadwalLabel" aria-hidden="true">
                            ...
                            <td>
                                <a class="btn btn-outline-dark" href="" data-toggle="modal" data-target="#ModalEdit<?php echo '_' . $ids; ?>"><i class="bi bi-pencil-square"></i></a>
                                <form method="POST" action="<?php echo site_url('admin/Adminpanel/hapus_sewa/') ?>">
                                    ...
                                    <button type="submit" class="btn btn-outline-dark tombolkirim"><i class="bi bi-trash"></i></button>
                                </form>
                            </td>
                        </tr>
                        <!-- Modal Detail -->
                        <div class="modal fade" id="ModalEdit<?php echo '_' . $ids; ?>" tabindex="-1" aria-labelledby="ModalJadwalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-xl">
                                <div class="modal-content">
                                    <div class="modal-header">
                                    ...
                                    <div class="modal-body">
                                        <form class="form" method="POST" action="<?php echo site_url('admin/Adminpanel/edit_status_sewa'); ?>">
                                            <p>Edit Status</p>
                                            <div class="form-row align-items-center">
                                                <div class="col-auto my-1">
                                                    <label class="mr-sm-2" for="inlineFormCustomSelect">Status
                                                        Main</label>
                                                    <input type="hidden" class="form-control" name="id_sewa" value="<?php echo $ids; ?>">
                                                ...
                                                <div class="col-auto my-1">
                                                    <label class="mr-sm-2" for="inlineFormCustomSelect">Status
                                                        Bayar</label>
                                                    <input type="hidden" class="form-control" name="id_bukti" value="<?php echo $idb; ?>">
                                                    <input type="hidden" class="form-control" name="bayar" value="<?php echo $tot; ?>">
                                                    <select class="custom-select mr-sm-2" id="inlineFormCustomSelect" name="status_byr">
                                        ...
                                        <form class="form" action="">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" readonly name="" value="<?php echo $username; ?>">
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleFormControlInput1">Lapangan</label>
                                                <input type="text" class="form-control" readonly name="" value="<?php echo 'Lapangan' . $val->id_lapangan; ?>">
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleFormControlInput1">Tanggal & Jam</label>
                                                <input type="text" class="form-control" readonly name="" value="<?php echo $val->tanggal . '/' . $nm_jam; ?>">
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleFormControlInput1">Total Bayar</label>
                                                <input type="text" class="form-control" readonly name="" value="<?php echo number_format($nm_harga, 0, ',', '.'); ?>">
                                            </div>
                                            <p><b>Data Pembayaran</b></p>
                                            <div class="form-group">
                                                <label for="exampleFormControlInput1">Jumlah dibayar (DP)</label>
                                                <input type="text" class="form-control" readonly name="" value="<?php echo number_format($dibayar, 0, ',', '.'); ?>">
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleFormControlInput1">Bukti</label>
                                                <img style="width: 100%; max-width: 580px; height: 500px; object-fit: contain;" src="<?php echo base_url('/upload_bukti/' . $bukti_tf) ?>" alt="">
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleFormControlInput1">Waktu Pembayaran</label>
                                                <input type="text" class="form-control" readonly name="" value="<?php echo $tgl_byr; ?>">
                                            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-2">
                <form class="form mt-5" method="POST" action="<?php echo site_url('admin/Adminpanel/cetak_sewa/') ?>" target="_blank">
                    <div class="row">
