        ...
        <div class="row">
            <div class="col-lg-12 col-12 mx-auto">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="row">
                            <form class="form mt-5" method="POST" action="<?php echo site_url('admin/Owner/laporancari/') ?>">
                                <div class="row">
                                    <?php
                                    if (isset($tgl_mulai) && isset($tgl_akhir)) { ?>
                                        <div class="col-md-4">
                                            <label for="" class="form-control">Dari</label>
                                            <input style="font-size: 12px;" type="date" class="form-control datepicker" name="tanggal_mulai" value="<?php echo $tgl_mulai; ?>">
                                        </div>
                                        <div class="col-md-4">
                                            <label for="" class="form-control">Sampai</label>
                                            <input style="font-size: 12px;" type="date" class="form-control datepicker" name="tanggal_akhir" value="<?php echo $tgl_akhir; ?>">
                                        </div>
                                        <div class="col-md-4">
                                    ...
                                    <?php } else { ?>
                                        <div class="col-md-4">
                                            <label for="" class="form-control">Dari</label>
                                            <input style="font-size: 12px;" type="date" class="form-control datepicker" name="tanggal_mulai" required>
                                        </div>
                                        <div class="col-md-4">
                                            <label for="" class="form-control">Sampai</label>
                                            <input style="font-size: 12px;" type="date" class="form-control datepicker" name="tanggal_akhir" required>
                                        </div>
                                        <div class="col-md-4">
    ...
    <div class="container">
        ...
        <?php if (isset($tgl_mulai) && isset($tgl_akhir)) { ?>
            <div class="row">
                ...
                <div class="col-md-2">
                    <form class="form mt-5" method="POST" action="<?php echo site_url('admin/Owner/cetak_laporan/') ?>" target="_blank">
                        <div class="row">
                            <div class="col-md-5">
                                <input style="font-size: 12px;" type="hidden" class="form-control datepicker" name="tanggal_mulai" value="<?php echo $tgl_mulai; ?>">
                            </div>
                            <div class="col-md-5">
                                <input style="font-size: 12px;" type="hidden" class="form-control datepicker" name="tanggal_akhir" value="<?php echo $tgl_akhir; ?>">
                            </div>
